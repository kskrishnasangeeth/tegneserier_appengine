...
class UpdateHandler(webapp.RequestHandler):
	comics_classes = {'Bizarro2': Bizarro2,'Bizarro3': Bizarro3, 'CyanideHappiness':CyanideHappiness, 'Dennis': Dennis, 'Fagprat': Fagprat, 'JoyOfTech': JoyOfTech,'Nemi1': Nemi1,'Nemi2': Nemi2,'Nemi3': Nemi3,'Rutetid': Rutetid,'SixChix': SixChix,'SixChix2': SixChix2,'TomToles': TomToles,'WulffmorgentHaler': WulffmorgentHaler,'Xkcd': Xkcd}
	def get(self):
